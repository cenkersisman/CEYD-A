...
if __name__ == '__main__':
    ...
    """ if len(sys.argv) < 3:
        print(
            "Please provide two arguments, first one is path to the wikipedia dump, second one is path to the output file")
...
"""
    ...
    inputFile = "trwiki-20200701-pages-articles.xml.bz2" #"sys.argv[1]
    outputFile = " wiki.tr.txt" #"sys.argv[2]
